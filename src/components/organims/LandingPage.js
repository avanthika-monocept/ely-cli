            ...
            {hasMore && (
              <TouchableOpacity
                ...
                <Timer
                  width={20}
                  height={20}
                  style={{marginRight: spacing.space_s1}}
                />
                <Text style={styles.recentConvoText}>
                  {stringConstants.showRecentConversations}
                </Text>
              </TouchableOpacity>
            )}
            <ScrollView
              ...
              <View style={styles.textContainer}>
                <Text style={styles.hiTextStyle}>
                  {stringConstants.hiThere} {firstName}
