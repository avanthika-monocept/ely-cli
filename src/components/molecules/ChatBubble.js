...
const ChatBubble = React.memo(
  ({
    ...
    const messageColor = isBot
      ? reconfigApiResponse?.theme?.botMessageColor.trim() ||
        colors.primaryColors.skyBlue
      : reconfigApiResponse?.theme?.userMessageColor.trim() ||
                ...
                {isLoader ? (
                  ...
                  <>
                    ...
                    {(media?.image?.[0]?.mediaUrl?.length > 0 ||
                      ...
                      <React.Suspense
                        fallback={<View style={styles.mediaPlaceholder} />}>
                        <MediaMessageView
...
const styles = StyleSheet.create({
  ...
  userBubbleWrapper: {
    alignSelf: 'flex-end',
    marginRight: Platform.OS == 'ios' ? spacing.space_s1 : spacing.space_m2,
    position: 'relative',
  },
  chatBubbleToUser: {
    alignSelf: 'flex-end',
  ...
  footer: {
    ...
    alignItems: 'center',
    marginBottom: Platform.OS == 'ios' ? spacing.space_m1 : spacing.space_s2,
  ...
  tailWrapperRight: {
    ...
    right: Platform.OS == 'ios' ? 2 : minusSpacing.minus_space_m,
    zIndex: -1,
  },
  reactionsContainer: {
    position: 'absolute',
